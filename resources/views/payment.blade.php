                        ...
                        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                            ...
                            <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                <li class="nav-item"> <a data-toggle="pill" href="#credit-card"
                                        class="nav-link active " style="background-color: #0abf53; color: #fff;"> <i
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                <form role="form" method="post" action="{!! URL::to('adyen') !!}">
                                    ...
                                    <div class="form-group"> <label for="username">
                                            <h6>Card Owner</h6>
                                        </label> <input type="text" name="card_holder" placeholder="Card Owner Name"
                                            required class="form-control" value="S. Hopper"> </div>
                                    <div class="form-group"> <label for="cardNumber">
                                            <h6>Card number</h6>
                                        </label>
                                        <div class="input-group"> <input type="text" name="cardNumber"
                                                placeholder="4111111111111111" class="form-control"
                                                value="test_4111111111111111" required>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="form-group"> <label><span class="hidden-xs">
                                                ...
                                                <div class="input-group"> <input type="text" placeholder="MM"
                                                        name="expiryMonth" value="test_03" class="form-control" required>
                                                    <input type="text" placeholder="YYYY" name="expiryYear"
                                                        value="test_2030" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group mb-4"> <label data-toggle="tooltip"
                                                ...
                                                </label> <input type="text" name="cvv" placeholder="CVV" value="test_737"
